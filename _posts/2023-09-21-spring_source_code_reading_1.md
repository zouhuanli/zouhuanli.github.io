...
# 二、Spring组件总览
    ...
    首先看下Spring官网的组件构成图：
![Spring-overview](https://github.com/zouhuanli/zouhuanli.github.io/tree/master/images/2023-09-21-spring_source_code_reading_1/spring-overview.png)
...
## 1.核心容器
    ...
    不会直接操纵BeanFactory。
![spring-core和spring-beans](https://github.com/zouhuanli/zouhuanli.github.io/tree/master/images/2023-09-21-spring_source_code_reading_1/core_and_beans.png)
...
## 3.Web模块
    ...
    portlet模块已经移除。
![spring-web](https://github.com/zouhuanli/zouhuanli.github.io/tree/master/images/2023-09-21-spring_source_code_reading_1/web.png)
## 4.AOP
...
![springdoc](https://github.com/zouhuanli/zouhuanli.github.io/tree/master/images/2023-09-21-spring_source_code_reading_1/springdoc.png)
